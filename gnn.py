...
def load_data():
    base_path = os.path.join(os.getcwd(), "drive", "Shareddrives", "MLNS", "centrale-supelec-mlns-dsba-2025")
...
def predict_on_test(model, data, test_edges, output_file="gnn_predictions.csv"):
    ...
    if output_file is None:
        base_path = os.path.dirname(os.path.join(os.getcwd(), "drive", "Shareddrives", "MLNS"))
...
def main():
    ...
    # 設定模型儲存路徑
    base_path = os.path.join(os.getcwd(), "drive", "Shareddrives", "MLNS")
